...
namespace BethBryo_for_Unity
{
	...
	public static class BytesToTypes
	{
		...
		/// Initialisation is done by calling this function like so: RefillBytesArray({FileStream}, {byte[]}, 4096)
		/// </summary>
		/// <param name="_fileStream">The FileStream you created for the file you want to read.</param>
		/// <param name="_byteArray">An empty byte array that has been initialised with an index size of exactly 4096 that will persist for the life of the FileStream.</param>
